...
// getField takes a path like "Effects[0].Color[0]" and turns it into a reflect.Value
// by looking up field
...
// looks up a field kkkkkkkkkkkkkk
func getFieldPart(field reflect.Value, part string) reflect.Value {
	...
	// if any indexes were given in the field part 
